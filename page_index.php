    ...
    <main role="main">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="B1.jpg" width="100%" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="B2.jpg"  width="100%" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="B3.jpg"  width="100%"  alt="Third slide">
            <div class="container">
      ...
      <div class="album py-5 bg-light">
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow reveal">
                ...
                <div class="card-body">
                  <p class="card-text">TV LG</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-danger">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
                    </div>
...
" class="card-img-top reveal" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">REFFRIGERATEUR LG</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-danger">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">CUISINIERE LG</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-danger">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">MACHINE A LAVER LG</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-danger">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">MICRO-ONDE LG</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-danger">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">TV HISENSE</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-info">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
                    </div>
                    <small class="text-muted">9 mins</small>
                  </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img src="audio_images/rm2.png" class="card-img-top reveal" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">AUDIO HISENSE</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-info">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">REFRIGERATEUR HISENSE</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-info">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">SPLIT HISENSE</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-info">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow ">
                <img src="cuisiniere_images/corre_oven_2.png" class="card-img-top reveal" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">CUISINIERE HISENSE</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-info">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">MACHINE A LAVER HISENSE</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-info">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <p class="card-text">MICRO-ONDE HISENSE</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-info">Acheter</button>
                      <button type="button" class="btn btn-sm btn-outline-dark">plus d'info</button>
  ...
  <div class="container px-4 py-5" id="custom-cards">
    <h2 class="pb-2 border-bottom">FMCG</h2>

    <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('unsplash-photo-1.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">HERO BABY</h3>
      ...
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('unsplash-photo-2.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">COUCHE YARA</h3>
      ...
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('unsplash-photo-3.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">DORCO</h3>
